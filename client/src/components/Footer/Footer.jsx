...
import { FaInstagram, FaLinkedin, FaDiscord, FaWhatsapp, FaEnvelope, FaMapMarkerAlt, FaPhone } from 'react-icons/fa';
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 md:gap-12 lg:gap-16 mb-6 sm:mb-8">
          ...
          <div className="col-span-1">
            ...
            <div className="flex gap-3 sm:gap-4">
              <a href="https://discord.gg/pbFZQMWYQu" title="Discord" className="group flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 text-white bg-white/10 rounded-full text-lg transition-all duration-300 ease-in-out hover:-translate-y-1 hover:bg-[#5865F2] hover:shadow-lg hover:shadow-[#5865F2]/30 backdrop-blur-sm">
                <FaDiscord />
              </a>
              <a href="https://x.com/TribeXesports" title="Twitter" className="group flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 text-white bg-white/10 rounded-full text-lg transition-all duration-300 ease-in-out hover:-translate-y-1 hover:bg-black hover:text-white hover:shadow-lg hover:shadow-gray-800/30 backdrop-blur-sm">
                <FaXTwitter />
              </a>
              <a href="https://www.instagram.com/tribexesports" title="Instagram" className="group flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 text-white bg-white/10 rounded-full text-lg relative overflow-hidden transition-all duration-300 ease-in-out hover:-translate-y-1 backdrop-blur-sm">
              ...
              <a href="https://www.linkedin.com/company/tribexesports/" title="LinkedIn" className="group flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 text-white bg-white/10 rounded-full text-lg transition-all duration-300 ease-in-out hover:-translate-y-1 hover:bg-[#0A66C2] hover:shadow-lg hover:shadow-[#0A66C2]/30 backdrop-blur-sm">
                <FaLinkedin />
              </a>
              <a href='https://whatsapp.com/channel/0029Vb6nTSk4o7qDjcH17I1K' target="_blank" rel="noopener noreferrer" title="Whatsapp" className="group flex items-center justify-center w-10 h-10 sm:w-11 sm:h-11 text-white bg-white/10 rounded-full text-lg transition-all duration-300 ease-in-out hover:-translate-y-1 hover:bg-[#25D366] hover:shadow-lg hover:shadow-[#25D366]/30 backdrop-blur-sm">
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li className="pt-4">
                <div className="flex items-center gap-2 text-white/90 text-sm sm:text-base">
                  ...
                  <a href="tel:+919376158532" className="hover:text-[#FC4E5B] transition-colors duration-300">+91 93761 58532</a>
                </div>
              </li>
              <li className="pt-2">
                <div className="flex items-center gap-2 text-white/90 text-sm sm:text-base">
                  <FaEnvelope className="text-[#E11D48]" />
                  <a href="mailto:support@tribexesports.com" className="hover:text-[#FC4E5B] transition-colors duration-300">support@tribexesports.com</a>
                </div>
              </li>
              <li className="pt-2">
                <div className="flex items-start gap-2 text-white/90 text-sm sm:text-base">
                  <FaMapMarkerAlt className="text-[#E11D48] mt-1" />
                  <address className="not-italic">
                    Sports Villa, Gurgaon,<br />
                    Haryana, 122103
                  </address>
                </div>
              </li>
